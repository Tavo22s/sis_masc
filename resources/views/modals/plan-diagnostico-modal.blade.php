<div wire:ignore.self class="modal fade" id="plan-diagnostico" data-bs-backdrop="static">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="cliente-nombre" class="form-control-label">{{ __('Diagnostico') }}</label>
                                <select wire:model.live="id_plan_diagnostico" class="form-select">
                            ...
                            <div class="form-group">
                                <label for="resultados" class="form-control-label">{{ __('Resultados') }}</label>
                                <div class="@error('resultados')border border-danger rounded-3 @enderror">
                                    <input wire:model="resultados" class="form-control" type="text" placeholder="Resultado">
                                        @error('resultados')
