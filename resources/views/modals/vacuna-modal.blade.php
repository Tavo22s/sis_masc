<div wire:ignore.self class="modal fade" id="vacuna-modal" data-bs-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Vacunas</h5>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="@error('nombre')border border-danger rounded-3 @enderror">
                                    <input wire:model="nombre" class="form-control" value="" type="text" placeholder="Nombre" name="nombre">
                                        @error('nombre')
