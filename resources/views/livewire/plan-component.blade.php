        ...
        <div class="col-6">
          <div class="card mb-4 mx-4">
            <div class="card-header pb-0">
                ...
                <button class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#plan-modal" type="button">+&nbsp; Agregar Diagnostico</button>
                </div>
            </div>
                  ...
                  <tbody>
                    @foreach ( $planes as $plan )
                        <tr>
                          <td>
                              <div class="my-auto">
                                  <h6 class="text-center text-xs">{{ $plan->nombre }}</h6>
                              </div>
                          </td>
