<div class="card mb-4 mx-4">
        <div class="card-header pb-0">
            ...
            <div class="d-flex flex-row justify-content-between">
                ...
                <button wire:click.prevent="default()" class="btn bg-gradient-secondary mb-0" data-bs-toggle="modal" data-bs-target="#examen-modal" type="button">+&nbsp; Agregar Examen</button>
            </div>
        </div>
                        ...
                        @foreach ($ex_medicos as $ex_medico)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a wire:click.prevent="Editar({{ $ex_medico->id }})" class="mx-3" data-bs-toggle="modal" data-bs-target="#examen-modal" href="javascript:void(0);">
