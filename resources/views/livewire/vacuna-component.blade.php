            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <div class="d-flex flex-row justify-content-between py-2">
                        ...
                        <button class="btn bg-gradient-primary mb-0" data-bs-toggle="modal" data-bs-target="#vacuna-modal" type="button">+&nbsp; Agregar Vacuna</button>
                    </div>
                </div>
